 ...
 * <p/>
 * Depends: <li> <i>NOT</i> on OpenOffice, as the Thumbnail is already inside the file. (184x256px
 * regardless of page orientation) (So if the thumbnail generation is not correct, it's OpenOffice's
 * fault, not our's :-)
 */
public class OpenOfficeThumbnailer extends AbstractThumbnailer {
    ...
    /**
     * Get a List of accepted File Types. All OpenOffice Formats are accepted.
     * @return MIME-Types
     */
