...
/**
 * This class uses Java Image I/O (Java's internal Image Processing library) in order to resize
 * images. JAI can be extended with extra Readers, this Thumbnailer will use all available image
 * readers.
 * <p/>
 * Depends: <li>JAI Image I/O Tools (optional, for TIFF support) (@see
 * http://java.net/projects/imageio-ext/ - licence not gpl compatible I suspect ...)
 */
public class NativeImageThumbnailer extends AbstractThumbnailer {
    ...
    /**
     * Get a List of accepted File Types. Normally, these are: bmp, jpg, wbmp, jpeg, png, gif The
