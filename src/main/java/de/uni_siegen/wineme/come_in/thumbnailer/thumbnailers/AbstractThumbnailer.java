...
/**
 * This AbstractThumbnailer may be used in order to implement only essential methods. It <li>stores
 * the current thumbnail height/width <li>implements an empty close method <li>specifies an wildcard
 * MIME Type as appropriate Filetype
 * @author Benjamin
 */
public abstract class AbstractThumbnailer implements Thumbnailer, ThumbnailerConstants {
    ...
    /**
     * This function will be called after all Thumbnails are generated. Note: This acts as a
     * Deconstructor. Do not expect this object to work after calling this method.
    ...
    /**
     * Get a list of all MIME Types that this Thumbnailer is ready to process. You should override
     * this method in order to give hints when which Thumbnailer is most appropriate. If you do not
     * override this method, the Thumbnailer will be called in any case - awaiting a
     * ThumbnailException if this thumbnailer cannot treat such a file.
    ...
    /**
     * Generate a Thumbnail of the input file. (You can override this method if you want to handle
     * the different MIME-Types).
